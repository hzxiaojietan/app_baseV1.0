...
import com.hzxiaojietan.base.common.utils.ScreenUtils;
...
public class EmptyView implements IEmptyView {
    ...
    public EmptyView(Context context, int w, int h) {
        mContext = context;
        mInflater = LayoutInflater.from(mContext);
        mWidth = w;
        mHeight = h;
    ...
    private void init() {
        mViewEmpty = mInflater.inflate(R.layout.view_empty, null);
        ...
        mViewError = mInflater.inflate(R.layout.view_error, null);
        ...
        mViewLoading = mInflater.inflate(R.layout.view_loading, null);
        ...
        LayoutParams lp = new LayoutParams(LayoutParams.MATCH_PARENT, ScreenUtils.getScreenWidth(mContext));
        ...
        //TODO:设置通用加载背景
        mEmptyRoot.setBackgroundResource(R.color.color10);
    ...
    public void showError() {
        ...
        //还原错误信息
        mTvError.setText(mContext.getString(R.string.place_hold_error));
    }
